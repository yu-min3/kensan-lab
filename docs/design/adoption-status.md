...
| 課題 | 内容 | 優先 |
|---|---|---|
| **アプリへの採用** | まだどの app も未採用。`apps/kensan-legacy/`（旧 kensan）は引退方向、`apps/kensan-next/` は frontend 未着手。next の frontend ができ次第 **最初から Whetstone で構築**するのが筋。legacy を移行するかは要判断 | 中 |
