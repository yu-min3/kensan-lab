...
<details markdown>
<summary><b>Capture guidelines (for contributors adding new screenshots)</b></summary>
...
- Keep captions outcome-focused: what the screen *proves*, not how to operate the
  tool (the captions above already follow this — adjust only if the shot differs).
