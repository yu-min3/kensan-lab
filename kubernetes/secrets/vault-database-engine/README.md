...
```bash
git mv kubernetes/secrets/vault-database-engine/platform-values/vault-database/kensan-dagster.yaml \
       apps/kensan/platform-values/vault-database/kensan-dagster.yaml
```
